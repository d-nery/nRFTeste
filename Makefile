...
flash load:
	...
	$(AT)STM32_Programmer_CLI -c port=SWD freq=1800 -w $(BUILD_DIR)/$(PROJECT_NAME).bin \
		0x08000000 -v -rst
...
# Show MCU info
info:
	$(AT)STM32_Programmer_CLI -c port=SWD freq=1800

# Reset MCU
reset:
	@echo "Reseting device"
	$(AT)STM32_Programmer_CLI -c port=SWD freq=1800 -rst
